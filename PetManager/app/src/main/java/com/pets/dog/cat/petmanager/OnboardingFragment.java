...
public class OnboardingFragment extends Fragment {
    ...
    protected ProfilesDatabaseAdapter profilesDatabaseAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        profilesDatabaseAdapter = new ProfilesDatabaseAdapter(getActivity());
        ...
        getStarted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                createUser();
                ((OnboardingActivity)getActivity()).showProfilesActivity();
            }
        });
    ...
    private void createUser(){
        Runnable cUserRunnable = new Runnable() {
            @Override
            public void run() {
                profilesDatabaseAdapter.createUser(1);
            }
        };
